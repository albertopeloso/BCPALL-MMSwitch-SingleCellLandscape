...
# ---- read in the  matrix ----
expMat <- ReadMtx(mtx="./matrixes_run4/_1_BCP-ALL-POOL1-POOL2-MAY24_DBEC_MolsPerCell_MEX/matrix.mtx",
                  cells="./matrixes_run4/_1_BCP-ALL-POOL1-POOL2-MAY24_DBEC_MolsPerCell_MEX/barcodes.tsv",
                  features="./matrixes_run4/_1_BCP-ALL-POOL1-POOL2-MAY24_DBEC_MolsPerCell_MEX/features.tsv") 
...
# ---- add cell assignment ----
cell_assign <- fread(file = "./matrixes_run4/_1_BCP-ALL-POOL1-POOL2-MAY24_Sample_Tag_Calls.csv",
                     sep = ",", header = T) %>%
...
sample_colors = c("PT13_DX" = "#769de4",
                  "PT13_D15" = "#523cd9",
                  "PT14_DX" = "#e5c07c",
                  "PT14_D15" = "#d9a13c",
                  "Multiplet" = "grey",
...
png(file="./qc_plots_run4/n_cells_x_sample.png",
...
png(file="./qc_plots_run4/n_cells_x_sample_no_multiplets_undet.png",
    height = 800, width = 1000, units = "px", res = 150)
seuratObj@meta.data %>%
  ggplot(aes(x = Sample_Name, fill = Sample_Name)) +
  geom_bar() +
...
png(file="./qc_plots_run4/umi_per_cell.png",
    height = 800, width = 1000, units = "px", res = 150)
seuratObj@meta.data %>%
...
png(file="./qc_plots_run4/genes_per_cell.png",
    height = 800, width = 1000, units = "px", res = 150)
seuratObj@meta.data %>%
...
png(file="./qc_plots_run4/mito_perc_per_cell.png",
    height = 800, width = 1000, units = "px", res = 150)
seuratObj@meta.data %>%
...
# ---- vlnplots for recap ----
png(file="./qc_plots_run4/vlnplot_recap.png",
...
png(file="./qc_plots_run4/complexity.png",
    height = 800, width = 1000, units = "px", res = 150)
seuratObj@meta.data %>%
...
png(file="./qc_plots_run4/qc_metrics_combo.png",
    height = 800, width = 1000, units = "px", res = 150)
seuratObj@meta.data %>%
...
saveRDS(seuratObj,
        file = "./seurat_objects_run4/bcpall_run4_seurat_unfiltered_step1.rds")
...
# ---- verify number of cells for each sample ----
png(file="./qc_plots_run4/n_cells_x_sample_filtered.png",
    height = 800, width = 1000, units = "px", res = 150)
...
png(file="./qc_plots_run4/umi_per_cell_filtered.png",
    height = 800, width = 1000, units = "px", res = 150)
final_filtered.seuratObj@meta.data %>%
  ggplot(aes(color = Sample_Name, x = nCount_RNA, fill = Sample_Name)) +
  geom_density(alpha = 0.2) +
...
# ---- visualize the number of genes per cell ----
# (valid cell at least 300 genes)
png(file="./qc_plots_run4/genes_per_cell_filtered.png",
    height = 800, width = 1000, units = "px", res = 150)
final_filtered.seuratObj@meta.data %>%
  ggplot(aes(color = Sample_Name, x = nFeature_RNA, fill = Sample_Name)) +
  geom_density(alpha = 0.2) +
...
saveRDS(final_filtered.seuratObj,
        file = "./seurat_objects_run4/bcpall_run4_seurat_filtered_with_ab_step1.rds")

saveRDS(ab, file = "./seurat_objects_run4/bcpall_run4_ab_step_1.rds")
