...
# ---- read in the  matrix ----
expMat <- ReadMtx(mtx="./matrixes_run2/BCP-ALL-JUL22_DBEC_MolsPerCell_MEX/matrix.mtx",
                  cells="./matrixes_run2/BCP-ALL-JUL22_DBEC_MolsPerCell_MEX/barcodes.tsv",
                  features="./matrixes_run2/BCP-ALL-JUL22_DBEC_MolsPerCell_MEX/features.tsv") 
...
# ---- add cell assignment ----
cell_assign <- fread(file = "./matrixes_run2/BCP-ALL-JUL22_Sample_Tag_Calls.csv",
                     sep = ",", header = T) %>%
...
sample_colors <- c("PT06_DX" = "#92a5eb",
                   "PT06_D15" = "#AC92EB",
                   "PT07_DX" = "#A0D568",
                   "PT07_D15" = "#6ad568",
                   "PT08_DX" = "#ED9255",
...
png(file="./qc_plots_run2/n_cells_x_sample.png",
...
png(file="./qc_plots_run2/n_cells_x_sample_no_multiplets_undet.png",
    height = 800, width = 1000, units = "px", res = 150)
seuratObj@meta.data %>%
  ggplot(aes(x = Sample_Name, fill = Sample_Name)) +
  geom_bar() +
...
png(file="./qc_plots_run2/umi_per_cell.png",
    height = 800, width = 1000, units = "px", res = 150)
seuratObj@meta.data %>%
...
png(file="./qc_plots_run2/genes_per_cell.png",
    height = 800, width = 1000, units = "px", res = 150)
seuratObj@meta.data %>%
...
png(file="./qc_plots_run2/mito_perc_per_cell.png",
    height = 800, width = 1000, units = "px", res = 150)
seuratObj@meta.data %>%
...
# ---- vlnplots for recap ----
png(file="./qc_plots_run2/vlnplot_recap.png",
...
png(file="./qc_plots_run2/complexity.png",
    height = 800, width = 1000, units = "px", res = 150)
seuratObj@meta.data %>%
...
png(file="./qc_plots_run2/qc_metrics_combo.png",
    height = 800, width = 1000, units = "px", res = 150)
seuratObj@meta.data %>%
...
saveRDS(seuratObj,
        file = "./seurat_objects_run2/bcpall_run2_seurat_unfiltered_step1.rds")
...
# ---- verify number of cells for each sample ----
png(file="./qc_plots_run2/n_cells_x_sample_filtered.png",
    height = 800, width = 1000, units = "px", res = 150)
...
png(file="./qc_plots_run2/umi_per_cell_filtered.png",
    height = 800, width = 1000, units = "px", res = 150)
final_filtered.seuratObj@meta.data %>%
  ggplot(aes(color = Sample_Name, x = nCount_RNA, fill = Sample_Name)) +
  geom_density(alpha = 0.2) +
...
# visualize the number of genes per cell 
# (valid cell at least 300 genes)
png(file="./qc_plots_run2/genes_per_cell_filtered.png",
    height = 800, width = 1000, units = "px", res = 150)
final_filtered.seuratObj@meta.data %>%
  ggplot(aes(color = Sample_Name, x = nFeature_RNA, fill = Sample_Name)) +
  geom_density(alpha = 0.2) +
...
saveRDS(final_filtered.seuratObj, 
        file = "./seurat_objects_run2/bcpall_run2_seurat_filtered_with_ab_step1.rds")

saveRDS(ab, file = "./seurat_objects_run2/bcpall_run2_ab_step_1.rds")
